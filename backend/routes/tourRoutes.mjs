...
import { clearCache } from '../middlewares/cache.mjs';
import { cacheResponse, clearCacheOnMutation } from '../middlewares/cacheMiddleware.mjs';
...
router.post(
  '/',
  requireAuth(['admin']),
  clearCacheOnMutation(['route:/api/tours*']),
