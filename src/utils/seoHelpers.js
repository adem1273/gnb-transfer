  ...
  const seoData = {
    home: {
      tr: {
        ...
        description: 'Türkiye\'nin en güvenilir transfer hizmeti. Konforlu araçlar, deneyimli şoförler, 7/24 hizmet. Havalimanı transferi ve şehir turları için hemen rezervasyon yapın.',
        keywords: 'havalimanı transferi, istanbul transfer, antalya transfer, turizm hizmetleri, vip transfer, özel araç kiralama',
      },
      en: {
        title: 'GNB Transfer | Professional Airport Transfer & Tourism Services',
        description: 'Turkey\'s most reliable transfer service. Comfortable vehicles, experienced drivers, 24/7 service. Book now for airport transfers and city tours.',
        keywords: 'airport transfer, istanbul transfer, antalya transfer, tourism services, vip transfer, private car rental',
      },
      ar: {
        title: 'GNB Transfer | خدمات النقل من المطار والسياحة المهنية',
        description: 'أكثر خدمات النقل موثوقية في تركيا. مركبات مريحة، سائقون ذوو خبرة، خدمة على مدار الساعة. احجز الآن لنقل المطار وجولات المدينة.',
      ...
      ru: {
        ...
        description: 'Самая надежная служба трансфера в Турции. Комфортные автомобили, опытные водители, круглосуточное обслуживание. Забронируйте трансфер из аэропорта и экскурсии по городу.',
        keywords: 'трансфер из аэропорта, трансфер Стамбул, трансфер Анталия, туристические услуги, VIP трансфер, аренда автомобиля',
      },
      de: {
        title: 'GNB Transfer | Professionelle Flughafentransfer & Tourismusdienstleistungen',
        description: 'Der zuverlässigste Transferservice der Türkei. Komfortable Fahrzeuge, erfahrene Fahrer, 24/7 Service. Jetzt buchen für Flughafentransfers und Stadtrundfahrten.',
        keywords: 'Flughafentransfer, Istanbul Transfer, Antalya Transfer, Tourismusdienstleistungen, VIP Transfer, Autovermietung',
      },
      fr: {
        title: 'GNB Transfer | Services professionnels de transfert aéroport et tourisme',
        description: 'Le service de transfert le plus fiable de Turquie. Véhicules confortables, chauffeurs expérimentés, service 24h/24. Réservez maintenant pour les transferts aéroport et les visites de la ville.',
        keywords: 'transfert aéroport, transfert Istanbul, transfert Antalya, services touristiques, transfert VIP, location de voiture',
      },
      es: {
        title: 'GNB Transfer | Servicios profesionales de traslado al aeropuerto y turismo',
        description: 'El servicio de traslado más confiable de Turquía. Vehículos cómodos, conductores experimentados, servicio 24/7. Reserve ahora para traslados al aeropuerto y tours por la ciudad.',
        keywords: 'traslado aeropuerto, traslado Estambul, traslado Antalya, servicios turísticos, traslado VIP, alquiler de coche',
      },
      zh: {
        title: 'GNB Transfer | 专业机场接送和旅游服务',
        description: '土耳其最可靠的接送服务。舒适的车辆，经验丰富的司机，24/7服务。立即预订机场接送和城市游览。',
        keywords: '机场接送，伊斯坦布尔接送，安塔利亚接送，旅游服务，VIP接送，租车',
      },
      fa: {
        title: 'GNB Transfer | خدمات حرفه‌ای ترانسفر فرودگاه و گردشگری',
        description: 'قابل اعتمادترین سرویس ترانسفر ترکیه. وسایل نقلیه راحت، رانندگان با تجربه، خدمات 24/7. همین الان برای ترانسفر فرودگاه و تورهای شهری رزرو کنید.',
        keywords: 'ترانسفر فرودگاه، ترانسفر استانبول، ترانسفر آنتالیا، خدمات گردشگری، ترانسفر VIP، اجاره خودرو',
      },
      hi: {
        title: 'GNB Transfer | पेशेवर हवाई अड्डा स्थानांतरण और पर्यटन सेवाएं',
        description: 'तुर्की की सबसे भरोसेमंद स्थानांतरण सेवा। आरामदायक वाहन, अनुभवी ड्राइवर, 24/7 सेवा। हवाई अड्डा स्थानांतरण और शहर के दौरे के लिए अभी बुक करें।',
        keywords: 'हवाई अड्डा स्थानांतरण, इस्तांबुल स्थानांतरण, अंटाल्या स्थानांतरण, पर्यटन सेवाएं, VIP स्थानांतरण, कार किराया',
      },
      it: {
        title: 'GNB Transfer | Servizi professionali di trasferimento aeroportuale e turismo',
        description: 'Il servizio di trasferimento più affidabile della Turchia. Veicoli confortevoli, autisti esperti, servizio 24/7. Prenota ora per trasferimenti aeroportuali e tour della città.',
        keywords: 'trasferimento aeroportuale, trasferimento Istanbul, trasferimento Antalya, servizi turistici, trasferimento VIP, noleggio auto',
      },
    },
    tours: {
      tr: {
        title: 'Turlar ve Geziler | GNB Transfer',
        description: 'İstanbul, Antalya ve Türkiye\'nin diğer şehirlerinde profesyonel tur hizmetleri. Özel turlar, grup turları ve şehir gezileri.',
        keywords: 'istanbul turu, antalya turu, şehir gezisi, özel tur, grup turu',
      },
      en: {
        title: 'Tours & Excursions | GNB Transfer',
        description: 'Professional tour services in Istanbul, Antalya and other Turkish cities. Private tours, group tours and city tours.',
    ...
    booking: {
      tr: {
        ...
        description: 'Online transfer rezervasyonu yapın. Anında onay, güvenli ödeme, en uygun fiyatlar. 7/24 müşteri desteği.',
        keywords: 'online rezervasyon, transfer rezervasyonu, havalimanı transfer rezervasyon',
      },
      en: {
        title: 'Make a Reservation | GNB Transfer',
        description: 'Book your transfer online. Instant confirmation, secure payment, best prices. 24/7 customer support.',
    ...
    blog: {
      tr: {
        ...
        description: 'Türkiye seyahat rehberi, transfer ipuçları, destinasyon önerileri ve turizm haberleri.',
        keywords: 'seyahat rehberi, türkiye turizm, transfer ipuçları, seyahat blog',
      },
      en: {
        title: 'Blog | GNB Transfer - Travel Tips & News',
        description: 'Turkey travel guide, transfer tips, destination recommendations and tourism news.',
