  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Get in touch with GNB Transfer for airport transfers, tours, and travel services in Turkey." />
      </Helmet>
              ...
              {submitStatus === 'success' && (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span>{t('contact.successMessage') || 'Message sent successfully! We\'ll get back to you soon.'}</span>
                  </div>
                </motion.div>
              )}
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">{t('contact.email') || 'Email'}</h3>
                    <a href="mailto:support@gnbpro.com" className="text-blue-600 hover:text-blue-700">
                      support@gnbpro.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">{t('contact.phone') || 'Phone'}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/905551234567" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700">
                      +90 555 123 4567
                    </a>
                    <p className="text-sm text-gray-500 mt-1">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">{t('contact.address') || 'Address'}</h3>
