                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div className="flex flex-col">
                          ...
                          {booking.childrenCount > 0 && (
                            <span className="text-xs">🧒 {booking.childrenCount}</span>
                          )}
                          {booking.infantsCount > 0 && (
                            <span className="text-xs">👶 {booking.infantsCount}</span>
                          )}
                        </div>
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                ...
                                <ul className="space-y-1 text-sm">
                                  {booking.extraServices.childSeat?.selected && (
                                    <li className="flex items-center gap-2">
                                      <span>🚼</span>
                                      <span>
                                        Child Seat x{booking.extraServices.childSeat.quantity}
                                      </span>
                                      <span className="text-green-600">
                                        (+$
                                        {(
                                          booking.extraServices.childSeat.quantity *
                                          (booking.extraServices.childSeat.price || 10)
                                        ).toFixed(2)}
                                        )
                                      </span>
                                    </li>
                                  ...
                                  {booking.extraServices.babySeat?.selected && (
                                    <li className="flex items-center gap-2">
                                      <span>👶</span>
                                      <span>
                                        Baby Seat x{booking.extraServices.babySeat.quantity}
                                      </span>
                                      <span className="text-green-600">
                                        (+$
                                        {(
                                          booking.extraServices.babySeat.quantity *
                                          (booking.extraServices.babySeat.price || 10)
                                        ).toFixed(2)}
                                        )
                                      </span>
                                    </li>
                                  ...
                                  {booking.extraServices.meetAndGreet?.selected && (
                                    <li className="flex items-center gap-2">
                                      ...
                                      <span className="text-green-600">
                                        (+$
                                        {(booking.extraServices.meetAndGreet.price || 15).toFixed(
                                          2
                                        )}
                                        )
                                      </span>
                                  ...
                                  {booking.extraServices.vipLounge?.selected && (
                                    <li className="flex items-center gap-2">
                                      ...
                                      <span className="text-green-600">
                                        (+$
                                        {(booking.extraServices.vipLounge.price || 50).toFixed(2)})
                                      </span>
                                    </li>
                                  )}
                                  {!booking.extraServices.childSeat?.selected &&
