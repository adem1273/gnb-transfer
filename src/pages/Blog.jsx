  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore our latest blog posts about tours, transfers, and travel tips."
        />
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            {t('blog.underConstruction') ||
              'Bu sayfa yapım aşamasındadır. Yakında seyahat ipuçları, tur önerileri ve daha fazlası için blog yazılarımızı burada bulabileceksiniz.'}
          </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-600">
                  {t('blog.feature2') || 'Destinasyon Rehberleri'}
                </span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0">
