                        ...
                        <div key={step} className="flex items-center flex-1">
                            <div className="relative flex flex-col items-center">
                                ...
                                <span className="text-xs mt-2 text-gray-600 absolute -bottom-6 whitespace-nowrap">
                                    {step === 1 ? t('booking.step1') || 'Personal Info' : 
                                     step === 2 ? t('booking.step2') || 'Tour Details' : 
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg">
                <AnimatePresence mode="wait">
                    {currentStep === 1 && (
                        ...
                        >
                            <h2 className="text-2xl font-bold mb-6 text-gray-800">{t('booking.personalInfo') || 'Personal Information'}</h2>
                    ...
                    {currentStep === 2 && (
                        <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                        >
                            <h2 className="text-2xl font-bold mb-6 text-gray-800">{t('booking.tourDetails') || 'Tour Details'}</h2>
                    ...
                    {currentStep === 3 && (
                        <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                        >
                            <h2 className="text-2xl font-bold mb-6 text-gray-800">{t('booking.reviewAndPay') || 'Review & Payment'}</h2>
