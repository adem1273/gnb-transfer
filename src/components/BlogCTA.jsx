...
function BlogCTA({ variant = 'default', className = '' }) {
  ...
  const variants = {
    default: {
      ...
      description:
        t('blog.cta.default.description') ||
        'Experience premium comfort and reliability with our professional transfer services.',
    ...
    tours: {
      ...
      description:
        t('blog.cta.tours.description') ||
        'Discover amazing destinations with our guided tours and excursions.',
    ...
    contact: {
      ...
      description:
        t('blog.cta.contact.description') ||
        'Our team is here to help you plan the perfect trip. Get in touch today!',
  ...
  return (
    <div className={`${cta.bg} text-white rounded-xl p-8 my-8 shadow-lg ${className}`}>
      <div className="max-w-3xl mx-auto text-center">
        <h3 className="text-2xl md:text-3xl font-bold mb-4">{cta.title}</h3>
        <p className="text-lg mb-6 opacity-90">{cta.description}</p>
        <Link
          to={cta.buttonLink}
